...
public final class DiagramProject {
    ...
    public DiagramProject withModel(DiagramModel updatedModel) {
        return new DiagramProject(metadata, updatedModel, layouts, styleSheet, viewState, dataDictionary, moduleMap, umlClassDiagram, rolesPermissions, screenFlow, wireframe, behaviorDiagram, architectureDiagram, freeGraph, logicalBusinessDocument, logicalBusinessGraphDocument, assetCatalog);
    }

    public DiagramProject withMetadata(ProjectMetadata updatedMetadata) {
        return new DiagramProject(updatedMetadata, model, layouts, styleSheet, viewState, dataDictionary, moduleMap, umlClassDiagram, rolesPermissions, screenFlow, wireframe, behaviorDiagram, architectureDiagram, freeGraph, logicalBusinessDocument, logicalBusinessGraphDocument, assetCatalog);
    }

    public DiagramProject withLayouts(DiagramLayouts updatedLayouts) {
        return new DiagramProject(metadata, model, updatedLayouts, styleSheet, viewState, dataDictionary, moduleMap, umlClassDiagram, rolesPermissions, screenFlow, wireframe, behaviorDiagram, architectureDiagram, freeGraph, logicalBusinessDocument, logicalBusinessGraphDocument, assetCatalog);
    }

    public DiagramProject withStyleSheet(DiagramStyleSheet updatedStyleSheet) {
        return new DiagramProject(metadata, model, layouts, updatedStyleSheet, viewState, dataDictionary, moduleMap, umlClassDiagram, rolesPermissions, screenFlow, wireframe, behaviorDiagram, architectureDiagram, freeGraph, logicalBusinessDocument, logicalBusinessGraphDocument, assetCatalog);
    }

    public DiagramProject withViewState(DiagramViewState updatedViewState) {
        return new DiagramProject(metadata, model, layouts, styleSheet, updatedViewState, dataDictionary, moduleMap, umlClassDiagram, rolesPermissions, screenFlow, wireframe, behaviorDiagram, architectureDiagram, freeGraph, logicalBusinessDocument, logicalBusinessGraphDocument, assetCatalog);
    }

    public DiagramProject withDataDictionary(DataDictionaryDocument updatedDataDictionary) {
        return new DiagramProject(metadata, model, layouts, styleSheet, viewState, updatedDataDictionary, moduleMap, umlClassDiagram, rolesPermissions, screenFlow, wireframe, behaviorDiagram, architectureDiagram, freeGraph, logicalBusinessDocument, logicalBusinessGraphDocument, assetCatalog);
    }

    public DiagramProject withModuleMap(ModuleMapDocument updatedModuleMap) {
        return new DiagramProject(metadata, model, layouts, styleSheet, viewState, dataDictionary, updatedModuleMap, umlClassDiagram, rolesPermissions, screenFlow, wireframe, behaviorDiagram, architectureDiagram, freeGraph, logicalBusinessDocument, logicalBusinessGraphDocument, assetCatalog);
    }

    public DiagramProject withUmlClassDiagram(UmlClassDiagramDocument updatedUmlClassDiagram) {
        return new DiagramProject(metadata, model, layouts, styleSheet, viewState, dataDictionary, moduleMap, updatedUmlClassDiagram, rolesPermissions, screenFlow, wireframe, behaviorDiagram, architectureDiagram, freeGraph, logicalBusinessDocument, logicalBusinessGraphDocument, assetCatalog);
    }

    public DiagramProject withRolesPermissions(RolesPermissionsDocument updatedRolesPermissions) {
        return new DiagramProject(metadata, model, layouts, styleSheet, viewState, dataDictionary, moduleMap, umlClassDiagram, updatedRolesPermissions, screenFlow, wireframe, behaviorDiagram, architectureDiagram, freeGraph, logicalBusinessDocument, logicalBusinessGraphDocument, assetCatalog);
    }

    public DiagramProject withScreenFlow(ScreenFlowDocument updatedScreenFlow) {
        return new DiagramProject(metadata, model, layouts, styleSheet, viewState, dataDictionary, moduleMap, umlClassDiagram, rolesPermissions, updatedScreenFlow, wireframe, behaviorDiagram, architectureDiagram, freeGraph, logicalBusinessDocument, logicalBusinessGraphDocument, assetCatalog);
    }

    public DiagramProject withWireframe(WireframeDocument updatedWireframe) {
        return new DiagramProject(metadata, model, layouts, styleSheet, viewState, dataDictionary, moduleMap, umlClassDiagram, rolesPermissions, screenFlow, updatedWireframe, behaviorDiagram, architectureDiagram, freeGraph, logicalBusinessDocument, logicalBusinessGraphDocument, assetCatalog);
    }

    public DiagramProject withBehaviorDiagram(BehaviorDiagramDocument updatedBehaviorDiagram) {
        return new DiagramProject(metadata, model, layouts, styleSheet, viewState, dataDictionary, moduleMap, umlClassDiagram, rolesPermissions, screenFlow, wireframe, updatedBehaviorDiagram, architectureDiagram, freeGraph, logicalBusinessDocument, logicalBusinessGraphDocument, assetCatalog);
    }

    public DiagramProject withArchitectureDiagram(ArchitectureDiagramDocument updatedArchitectureDiagram) {
        return new DiagramProject(metadata, model, layouts, styleSheet, viewState, dataDictionary, moduleMap, umlClassDiagram, rolesPermissions, screenFlow, wireframe, behaviorDiagram, updatedArchitectureDiagram, freeGraph, logicalBusinessDocument, logicalBusinessGraphDocument, assetCatalog);
    }
    ...
    public DiagramProject withFreeGraph(FreeGraphDocument updatedFreeGraph) {
        return new DiagramProject(metadata, model, layouts, styleSheet, viewState, dataDictionary, moduleMap,
                ...
                updatedFreeGraph, logicalBusinessDocument, logicalBusinessGraphDocument, assetCatalog);
    }

    public DiagramProject withLogicalBusinessDocument(LogicalBusinessDocument updatedLogicalBusinessDocument) {
        return new DiagramProject(metadata, model, layouts, styleSheet, viewState, dataDictionary, moduleMap,
                umlClassDiagram, rolesPermissions, screenFlow, wireframe, behaviorDiagram, architectureDiagram,
                freeGraph, updatedLogicalBusinessDocument, logicalBusinessGraphDocument, assetCatalog);
    }

    public DiagramProject withLogicalBusinessGraphDocument(LogicalBusinessGraphDocument updatedLogicalBusinessGraphDocument) {
        return new DiagramProject(metadata, model, layouts, styleSheet, viewState, dataDictionary, moduleMap,
                umlClassDiagram, rolesPermissions, screenFlow, wireframe, behaviorDiagram, architectureDiagram,
                freeGraph, logicalBusinessDocument, updatedLogicalBusinessGraphDocument, assetCatalog);
    }

    public DiagramProject withAssetCatalog(ProjectAssetCatalog updatedAssetCatalog) {
        return new DiagramProject(metadata, model, layouts, styleSheet, viewState, dataDictionary, moduleMap,
                umlClassDiagram, rolesPermissions, screenFlow, wireframe, behaviorDiagram, architectureDiagram,
                freeGraph, logicalBusinessDocument, logicalBusinessGraphDocument, updatedAssetCatalog);
    }
}
