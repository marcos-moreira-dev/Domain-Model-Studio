...
import com.marcosmoreira.domainmodelstudio.application.export.ExportPdfUseCase;
...
public final class ExportApplicationServices {
    ...
    public ExportApplicationServices(
        ...
        this.exportPdfUseCase = Objects.requireNonNull(exportPdfUseCase, "exportPdfUseCase");
