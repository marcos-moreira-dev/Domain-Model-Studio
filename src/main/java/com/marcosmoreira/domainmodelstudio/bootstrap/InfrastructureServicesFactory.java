...
public final class InfrastructureServicesFactory {
    ...
    public InfrastructureServices create() {
        ...
        LogicalBusinessPdfExporter logicalBusinessPdfExporter = new LogicalBusinessPdfExporter();
        DelegatingPdfDiagramExporter pdfExporter = new DelegatingPdfDiagramExporter(Map.of(
                DiagramTypeId.DATA_DICTIONARY, dataDictionaryPdfExporter,
                DiagramTypeId.LOGICAL_BUSINESS_INTAKE, logicalBusinessPdfExporter));
