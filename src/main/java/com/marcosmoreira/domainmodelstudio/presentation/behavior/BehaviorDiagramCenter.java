...
final class BehaviorDiagramCenter {
    ...
    private final VisualCommentCanvasAdapter behaviorAdapter;
    private final VisualCommentCanvasAdapter sequenceAdapter;
    private final VisualCommentRenderKit behaviorRenderKit;
    private final VisualCommentRenderKit sequenceRenderKit;
    ...
    BehaviorDiagramCenter(BehaviorDiagramViewModel viewModel) {
        ...
        this.behaviorAdapter = new VisualCommentCanvasAdapter(new BehaviorCanvasAdapter(viewModel));
        this.sequenceAdapter = new VisualCommentCanvasAdapter(new SequenceCanvasAdapter(viewModel));
        this.behaviorRenderKit = new VisualCommentRenderKit(new BehaviorRenderKit());
        this.sequenceRenderKit = new VisualCommentRenderKit(new SequenceRenderKit());
    ...
    void activateVisualCommentTool() {
        activeAdapter().activateCommentPlacement();
    }

    boolean reorderSelectedVisualComment(VisualLayerOrderCommand command) {
        return activeAdapter().reorderSelectedVisualComment(command);
    }

    boolean resizeSelectedVisualComment(VisualNodeSizeCommand command) {
        return activeAdapter().resizeSelectedVisualComment(command.factor());
    }
    ...
    private VisualCommentCanvasAdapter activeAdapter() {
        return isSequenceDiagram() ? sequenceAdapter : behaviorAdapter;
    }


    private VisualCommentRenderKit activeRenderKit() {
