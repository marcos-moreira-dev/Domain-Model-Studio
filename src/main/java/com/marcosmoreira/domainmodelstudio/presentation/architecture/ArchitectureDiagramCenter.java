...
final class ArchitectureDiagramCenter {
    ...
    private final ArchitectureCanvasAdapter canvasAdapter;
    private final ArchitectureRenderKit renderKit = new ArchitectureRenderKit();
    ...
    ArchitectureDiagramCenter(ArchitectureDiagramViewModel viewModel) {
        ...
        this.canvasAdapter = new ArchitectureCanvasAdapter(viewModel);
