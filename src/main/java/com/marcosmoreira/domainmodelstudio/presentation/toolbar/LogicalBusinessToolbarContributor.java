    ...
    public List<DiagramToolbarAction> actionsFor(DiagramTypeId diagramTypeId) {
        return List.of(
                ...
                action(
                        ...
                        "Impacto",
                        "Abrir impacto y dependencias del levantamiento activo",
                ...
                action(
                        ...
                        "Ficha rápida",
                        "Abrir el resumen lateral del foco seleccionado",
                ...
                action(
                        DiagramToolbarActionId.EXPORT_PDF,
                        "PDF",
                        "Exportar el levantamiento logico completo como PDF formal",
