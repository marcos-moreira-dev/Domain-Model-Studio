...
final class DiagramToolbarActionFactory {
    ...
    static DiagramToolbarAction visualCommentAction() {
        return action(DiagramToolbarActionId.ADD_VISUAL_COMMENT, "Comentario",
                "Coloca una nota visual libre en el canvas.",
                ToolbarIcon.MANUAL, DiagramToolbarSection.ELEMENTS, DiagramToolbarAction.Width.WIDE);
    }
