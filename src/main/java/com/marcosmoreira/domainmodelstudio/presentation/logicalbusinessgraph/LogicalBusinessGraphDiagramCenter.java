...
final class LogicalBusinessGraphDiagramCenter {
    ...
    LogicalBusinessGraphDiagramCenter(LogicalBusinessGraphViewModel viewModel) {
        ...
        this.canvasAdapter = new VisualCommentCanvasAdapter(new LogicalBusinessGraphCanvasAdapter(viewModel));
        this.renderKit = new VisualCommentRenderKit(new LogicalBusinessGraphRenderKit());
