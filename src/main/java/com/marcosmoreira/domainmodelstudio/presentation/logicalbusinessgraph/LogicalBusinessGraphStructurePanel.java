...
final class LogicalBusinessGraphStructurePanel {
    ...
    private final LogicalBusinessGraphAccordionTabs accordionTabs;
    ...
    LogicalBusinessGraphStructurePanel(LogicalBusinessGraphViewModel viewModel, Runnable refreshCanvas) {
        ...
        this.accordionTabs = new LogicalBusinessGraphAccordionTabs(this.viewModel, this.refreshCanvas);
    ...
    private VBox buildContent() {
        ...
        tabs.getTabs().setAll(
                new Tab("Nodos", accordionTabs.nodeTab()),
                new Tab("Relaciones", accordionTabs.edgeTab()),
                new Tab("Leyenda", legendView()),
                new Tab("Validación", issueList)
        );
        content.getChildren().addAll(hint, tabs);
        accordionTabs.refresh();
        return content;
    }
