...
final class ScreenFlowDiagramCenter {
    ...
    ScreenFlowDiagramCenter(ScreenFlowViewModel viewModel) {
        ...
        this.canvasAdapter = new VisualCommentCanvasAdapter(new ScreenFlowCanvasAdapter(viewModel));
        this.renderKit = new VisualCommentRenderKit(new ScreenFlowRenderKit());
