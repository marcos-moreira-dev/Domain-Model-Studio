...
final class FreeGraphDiagramCenter {
    ...
    FreeGraphDiagramCenter(FreeGraphViewModel viewModel) {
        ...
        this.canvasAdapter = new VisualCommentCanvasAdapter(new FreeGraphCanvasAdapter(viewModel));
        this.renderKit = new VisualCommentRenderKit(new FreeGraphRenderKit());
