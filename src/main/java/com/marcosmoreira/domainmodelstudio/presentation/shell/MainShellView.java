...
public final class MainShellView {
    ...
    private Menu buildExportMenu() {
        ...
        menu.getItems().addAll(
                ...
                commandItem("Exportar documento PDF...", viewModel::exportDataDictionaryPdf, null, exportUnavailable(ExportFormat.PDF)),
                new SeparatorMenuItem(),
    ...
    private BorderPane buildWorkArea() {
        ...
        LogicalBusinessEditorView logicalBusinessEditor = new LogicalBusinessEditorView(viewModel.logicalBusinessViewModel());
