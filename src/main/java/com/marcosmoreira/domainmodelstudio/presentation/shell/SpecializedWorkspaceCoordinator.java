...
final class SpecializedWorkspaceCoordinator {
    ...
    private record SpecializedWorkspaceBinding(
        ...
        static SpecializedWorkspaceBinding of(
            ...
            return new SpecializedWorkspaceBinding(supportedType, loader, clearer, active, projectSupplier,
                    fitDiagramAction, centerDiagramAction, deleteSelectedBendPointAction, command -> false, command -> false, true);
        }
        ...
        static SpecializedWorkspaceBinding of(
            ...
            return new SpecializedWorkspaceBinding(supportedType, loader, clearer, active, projectSupplier,
                    fitDiagramAction, centerDiagramAction, deleteSelectedBendPointAction, layerOrderAction, command -> false, true);
        }
        ...
        static SpecializedWorkspaceBinding of(
            ...
            return new SpecializedWorkspaceBinding(supportedType, loader, clearer, active, projectSupplier,
                    fitDiagramAction, centerDiagramAction, deleteSelectedBendPointAction, layerOrderAction, nodeSizeAction, true);
        }
