...
final class ModuleMapDiagramCenter {
    ...
    ModuleMapDiagramCenter(ModuleMapViewModel viewModel) {
        ...
        this.canvasAdapter = new VisualCommentCanvasAdapter(new ModuleMapCanvasAdapter(viewModel));
        this.renderKit = new VisualCommentRenderKit(new ModuleMapRenderKit());
