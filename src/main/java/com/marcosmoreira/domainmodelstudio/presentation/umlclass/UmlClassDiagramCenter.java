...
final class UmlClassDiagramCenter {
    ...
    UmlClassDiagramCenter(UmlClassDiagramViewModel viewModel) {
        ...
        this.canvasAdapter = new VisualCommentCanvasAdapter(new UmlClassCanvasAdapter(viewModel));
        this.renderKit = new VisualCommentRenderKit(new UmlClassRenderKit(viewModel));
