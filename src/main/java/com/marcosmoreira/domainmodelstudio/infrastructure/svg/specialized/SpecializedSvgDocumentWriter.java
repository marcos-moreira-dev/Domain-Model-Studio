...
final class SpecializedSvgDocumentWriter {
    ...
    void appendStyles(StringBuilder svg) {
        svg.append("  <style><![CDATA[\n")
                ...
                .append("    .node-visual-comment rect.body { fill: #FFFFFF; stroke: #64748B; stroke-width: 1.25; rx: 0; ry: 0; }\n")
                .append("    .node-visual-comment rect.header { fill: #FFFFFF; stroke: #64748B; stroke-width: 1; rx: 0; ry: 0; }\n")
