...
Levantamiento lógico   → PDF, Markdown
...
PDF se usa para documentos formales. En el cierre actual aplica a salidas documentales con reporte definido.

```txt
Diccionario de datos → PDF profesional
Levantamiento lógico → PDF formal del expediente completo con índice navegable, guía de lectura y glosario de códigos
