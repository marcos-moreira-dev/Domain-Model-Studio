...
`logical-business-intake` importa un expediente documental. No abre canvas, no exporta PNG/SVG y no reemplaza la revisión humana. Sus salidas documentales son PDF formal, Markdown revisable y `.dms` editable.
