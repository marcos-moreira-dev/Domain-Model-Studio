...
- muestra trazas internas del mismo expediente;
- ofrece ayuda y glosario obligatorio;
- exporta Markdown canónico.
...
El Levantamiento lógico es una fuente lógica canónica. No genera automáticamente todos los demás proyectos, no sincroniza proyectos y expone coherencia interna, trazas internas, ayuda y glosario. UENS es el ejemplo oficial rector.
