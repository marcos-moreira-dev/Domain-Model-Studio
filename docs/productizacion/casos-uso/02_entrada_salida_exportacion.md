...
| Exportación PDF | 70% | Específica | Real para diccionario; no debe aparecer para diagramas visuales. |
...
| Anclaje observado | `DataDictionaryPdfExporter`, `ExportDataDictionaryPdfUseCase`. |
| Estado | **Terminado específico — 70%** |
| Falta | Probar PDF con diccionario grande y textos largos. No ofrecer PDF general si no existe. |
