...
| UC-EXP-04 | Exportar PDF de diccionario | Generar documento técnico imprimible. | `PDF` | `ExportDataDictionaryPdfUseCase`, `DataDictionaryPdfExporter` | Diccionario exporta PDF; otros tipos no deben mostrar PDF. | Real por código |
...
| DIC-07 Exportar PDF | Generar PDF técnico. | `ExportDataDictionaryPdfUseCase`, `DataDictionaryPdfExporter` | PDF solo disponible en diccionario. | Real por código |
...
- [ ] Exportar PDF solo si es diccionario.
