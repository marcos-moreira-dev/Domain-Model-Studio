...
- [ ] Exportar PDF desde Diccionario de datos y Levantamiento lógico.
- [ ] El PDF documental tiene portada/contenido legible.
...
- [ ] El módulo SideDock `Exportar` aparece después de `Impacto y dependencias` y permite exportar PDF.
- [ ] Exportar PDF genera un expediente completo sin controles de UI.
