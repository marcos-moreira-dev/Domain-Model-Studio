...
| Levantamiento lógico | `logical-business-intake` | `CAT-PROJ`, `CAT-IMPORT`, `CAT-EXPORT`, `CAT-HELP-AI`, `CAT-DOC` | `PARCIAL` | Artefacto documental estructurado; importa/exporta Markdown y deriva borradores revisables sin prometer canvas visual. |
