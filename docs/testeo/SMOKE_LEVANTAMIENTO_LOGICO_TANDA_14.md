...
- [ ] La toolbar contextual muestra acciones de modelo, vista y exportación Markdown.

## LG-SMOKE-002 — SideDock y árbol del expediente

- [ ] El SideDock muestra Estructura, Propiedades, Elementos lógicos, Entidades y relaciones, Validación, Trazas internas y Ayuda y glosario.
...
- [ ] Abrir Trazas internas y confirmar relaciones entrantes/salientes o ausencia explicada.
