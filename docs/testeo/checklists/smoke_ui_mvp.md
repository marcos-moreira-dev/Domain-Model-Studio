...
- [ ] Verificar PDF solo para tipos documentales con exportador registrado.
...
- [ ] Levantamiento lógico: importar UENS, revisar SideDock Exportar, exportar PDF formal y Markdown; reabrir `.dms`.
